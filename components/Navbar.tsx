...
const navItems = [
  ...
  {href: "/reels",label: "🔥Today’s Viral Idea"},
  // { href: "/holi-ai", label: "Holi AI" }, // ✅ Added Holi
...
export default function Navbar() {
  ...
  // ✅ ONE-TIME redirect to Holi AI on first load
  // useEffect(() => {
  //   const hasRedirected = sessionStorage.getItem("kanova_holi_redirect");

  //   if (!hasRedirected && window.location.pathname === "/") {
  //     sessionStorage.setItem("kanova_holi_redirect", "true");
  //     router.replace("/holi-ai");
  //   }
  ...
  // new new new 
   useEffect(() => {
    const hasRedirected = sessionStorage.getItem("reels_redirect");

    if (!hasRedirected && window.location.pathname === "/") {
      sessionStorage.setItem("reels_redirect", "true");
